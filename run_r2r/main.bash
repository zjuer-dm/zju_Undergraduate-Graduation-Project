...
flag1="--exp_name release_r2r_dagger_test
      --run-type dagger
      --exp-config run_r2r_code/iter_train.yaml
      SIMULATOR_GPU_IDS [0]
      TORCH_GPU_IDS [0]
      GPU_NUMBERS 1
      NUM_ENVIRONMENTS 2
...
# CUDA_VISIBLE_DEVICES=5 bash run_r2r_code/main_server.bash dagger 9999
# CUDA_VISIBLE_DEVICES=4,5,6,7 bash run_r2r_code/main_server.bash grpo 2333
# CUDA_VISIBLE_DEVICES=4,5,6,7 bash run_r2r_code/main_server.bash eval 2333
# CUDA_VISIBLE_DEVICES=4,5,6,7 bash run_r2r_code/main_server.bash infer 2333
