...
''' Script to precompute image features using a Pytorch ResNet CNN, using 12 discretized views
    at each viewpoint (4 cameras * 3 elevation levels, 90 degree horizontal increments),
    and the provided camera WIDTH, HEIGHT and VFOV parameters. '''
...
# 4-camera setup: 4 horizontal views * 3 elevation levels = 12 views
# (changed from 12-camera: 12 * 3 = 36 views)
